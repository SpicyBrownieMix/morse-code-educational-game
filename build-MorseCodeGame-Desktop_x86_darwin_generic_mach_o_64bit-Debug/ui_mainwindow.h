...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        CaptainDialogueText->setWordWrap(true);
        ...
        startScreenBackground->setFont(font4);
        ...
        QFont font5;
        font5.setFamilies({QString::fromUtf8("Bauhaus 93")});
        font5.setPointSize(45);
        newGameButton->setFont(font5);
        assessmentButton = new QPushButton(centralwidget);
        assessmentButton->setObjectName("assessmentButton");
        assessmentButton->setEnabled(true);
        assessmentButton->setGeometry(QRect(549, 180, 171, 32));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        assessmentButton->setText(QCoreApplication::translate("MainWindow", "Translate Secret Message", nullptr));
    } // retranslateUi
